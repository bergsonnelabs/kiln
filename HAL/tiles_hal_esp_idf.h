 ...
 *
 *   tiles_hal_esp_idf_cfg_t cfg = {
 *       .i2c_bus = bus_handle,
 *       .buses = TILES_BUS_I2C,
 *   };
 *   tiles_hal_t hal;
 *   tiles_hal_esp_idf_init(&hal, &cfg);
 * @endcode
 */

#ifndef TILES_HAL_ESP_IDF_H_
#define TILES_HAL_ESP_IDF_H_
...
} tiles_hal_esp_idf_cfg_t;

/**
 * @brief  Initialize a tiles_hal_t from an ESP-IDF configuration.
 *
