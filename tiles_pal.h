 ...
 * accepts a tiles_pal_t pointer instead of a platform-specific handle,
 ...
 * that populates the tiles_pal_t function pointers for your target's
...
#ifndef INC_TILES_PAL_H_
#define INC_TILES_PAL_H_
...
typedef struct {
     ...
     *
     * @param  handle   Opaque platform handle (stored in tiles_pal_t.handle)
