/*
 * tile_sense_i_9_dmp3.c — ICM-20948 DMP3 firmware blob (binary).
 *
 * Vendored from the SparkFun ICM-20948 Arduino library; that file
 * itself is TDK's eMD-SmartMotion-ICM20948-1.1.0-MP DMP3 image.
 * MIT-licensed wrapper; the blob is TDK's IP, distributed by TDK
 * for use with the ICM-20948 chip. See tile_sense_i_9_dmp3.h for
 * the upstream URL + regen procedure.
 *
 * Do not edit. ~14 KB of read-only firmware.
 */
#include "tile_sense_i_9_dmp3.h"

const uint8_t icm20948_dmp3_firmware[ICM20948_DMP_FIRMWARE_SIZE] = {
