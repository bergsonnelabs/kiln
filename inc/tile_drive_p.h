#ifndef INC_TILE_DRIVE_P_
#define INC_TILE_DRIVE_P_
...
#define TILE_DRIVE_P_MODE_IDLE           0
#define TILE_DRIVE_P_MODE_SENSE_FINE     1
#define TILE_DRIVE_P_MODE_SENSE_COARSE   2
#define TILE_DRIVE_P_MODE_PLAY_DIRECT    3
